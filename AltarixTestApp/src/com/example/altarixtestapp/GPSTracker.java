...
public class GPSTracker extends Service implements LocationListener {
	...
	private final GPSTrackingActivity mContext;
	...
	public GPSTracker(GPSTrackingActivity context) {
	...
	public void showSettingsAlert() {
		...
		alertDialog.setPositiveButton(
				mContext.getResources().getString(R.string.settings),
	...
	public void onLocationChanged(Location location) {
		this.mContext.onLocationChanged(latitude, longitude);
